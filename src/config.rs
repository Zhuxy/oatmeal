...
impl ToString for ConfigKey {
    fn to_string(&self) -> String {
        match self {
            ...
            ConfigKey::AzureAIURL => return String::from("azureai-url"),
            ConfigKey::AzureAIAPIKey => return String::from("azureai-api-key"),
            ConfigKey::AzureAIAPIVersion => return String::from("azureai-api-version"),
            ConfigKey::AzureAIDeploymentID => return String::from("azureai-deployment-id"),
