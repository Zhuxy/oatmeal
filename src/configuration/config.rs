...
impl Config {
    ...
    pub fn default(key: ConfigKey) -> String {
        ...
        let res = match key {
            ...
            ConfigKey::AzureAIURL => "azureai-url",
            ConfigKey::AzureAIAPIKey => "azureai-api-key",
            ConfigKey::AzureAIAPIVersion => "azureai-api-version",
            ConfigKey::AzureAIDeploymentID => "azureai-deployment-id",
        };
